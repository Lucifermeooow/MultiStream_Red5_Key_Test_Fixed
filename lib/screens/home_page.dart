...
class _HomePageState extends State<HomePage> {
  final _publishUrl = TextEditingController(
    text: 'rtmp://userId-3125-1b12964663-stream-proxy.cloud.red5.net:1935/live/multistream-test',
  );
  ...
  Future<void> _stop() async {
    ...
    try{await _camera?.stopVideoStreaming(); await WakelockPlus.disable();
